...
if __name__ == '__main__':
  ...
  if not os.path.isdir("intermediate_graph"):
      os.makedirs("intermediate_graph")

  if not os.path.isdir("labels"):
      os.makedirs("labels")

  if not os.path.isdir("retrain_logs"):
      os.makedirs("retrain_logs")
  ...
  parser.add_argument(
      '--output_graph',
      type=str,
      default='./models/retrained_graph_mn.pb',
  ...
  parser.add_argument(
      '--output_labels',
      type=str,
      default='./labels/retrained_labels_mn.txt',
